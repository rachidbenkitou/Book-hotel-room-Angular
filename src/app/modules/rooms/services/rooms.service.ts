...
export class RoomsService {
  ...
  hotelUrl: string = `${environment.appUrl}rooms`
  ...
  public countRoomsByHotelId(hotelId?: number): Observable<number> {
    return this.http.get<number>(`${this.hotelUrl}/countRoomsByHotelId/${hotelId}`);
  }
